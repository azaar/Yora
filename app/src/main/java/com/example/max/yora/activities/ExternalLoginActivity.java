...
public class ExternalLoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedState) {
        ...
        webView.loadUrl(YoraApplication.API_ENDPOINT
                ...
                + "&response_type=token&client_id=android&redirect_uri="
                + "http%3A%2F%2F" + YoraApplication.API_ENDPOINT.getHost() + "%2Fmobile-login"
                + "&student_token=" + YoraApplication.STUDENT_TOKEN);
